...
- **Pasar lista por clase y día**: eliges una clase y una fecha, ves a todos los alumnos en una rejilla de casillas (mañana / tarde / retraso, cada una con su propia casilla de "justificado"), y guardas todo el día de una vez. Una falta de mañana y un retraso de mañana son mutuamente excluyentes y comparten la misma casilla de "justificado", ya que solo uno de los dos puede haber ocurrido de verdad.
- **Resumen de ausencias en tiempo real**: porcentaje de asistencia automático por alumno (ponderado — faltar una mañana no cuenta igual que faltar una tarde, siguiendo el horario real del colegio), desglosado entre falta justificada/no justificada, un desglose también para los retrasos (justificados/no justificados), un nivel de alerta progresivo por colores, un desglose por día de la semana, un buscador y columnas ordenables.
- **Control de acceso**: restringido a una lista explícita de emails del profesorado autorizado, comprobada en el servidor en cada petición — no solo un enlace difícil de adivinar. Las hojas de administración (configuración, lista de alumnos, lista de profesorado, mapa de promoción) están protegidas a nivel de la propia Sheet para que solo la persona propietaria del archivo pueda editarlas, aunque el resto del profesorado necesite acceso de Editor para que funcione la aplicación.
